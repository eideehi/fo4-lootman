...
namespace
{
	...
	constexpr LabelRow kLabelRows[] = {
		...
		{ LabelPage::kPrimary, 5, LabelKind::kBoolProperty, properties::ignore_overweight },
		{ LabelPage::kPrimary, 6, LabelKind::kBoolProperty, properties::loot_is_deliver_to_player },
		{ LabelPage::kPrimary, 7, LabelKind::kBoolProperty, properties::looting_without_logs },
		{ LabelPage::kPrimary, 8, LabelKind::kBoolProperty, properties::not_looting_from_settlement },
