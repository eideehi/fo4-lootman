...
Event Actor.OnPlayerLoadGame(Actor akSender)
    LTMN:Debug.OpenLog();; Debug
    LTMN:Debug.Log("| System | Lootman has been running");; Debug
...
Event Actor.OnLocationChange(Actor akSender, Location akOldLoc, Location akNewLoc)
    ...
    LTMN:Debug.Log(prefix + "*** Start the process that will be executed when the location is changed ***");; Debug
    LTMN:Debug.Log(prefix + "  Old location: [Name: " + LTMN:Debug.GetIdentify(akOldLoc) + ", ID: " + LTMN:Debug.GetHexID(akOldLoc) + "]");; Debug
    LTMN:Debug.Log(prefix + "  New location: [Name: " + LTMN:Debug.GetIdentify(akNewLoc) + ", ID: " + LTMN:Debug.GetHexID(akNewLoc) + "]");; Debug

    LTMN:Debug.Log(prefix + "  Suppression of automatic looting in settlement: " + (properties.LootingDisabledInSettlement.GetValueInt() == 1));; Debug
    If (properties.LootingDisabledInSettlement.GetValueInt() == 1)
        LTMN:Debug.Log(prefix + "    New location is a settlement (LocTypeSettlement): " + akNewLoc.HasKeyword(Game.GetCommonProperties().LocTypeSettlement));; Debug
        LTMN:Debug.Log(prefix + "    New location is a settlement (LocTypeWorkshopSettlement): " + akNewLoc.HasKeyword(Game.GetCommonProperties().LocTypeWorkshopSettlement));; Debug
        ...
        If (akNewLoc.HasKeyword(Game.GetCommonProperties().LocTypeSettlement) || akNewLoc.HasKeyword(Game.GetCommonProperties().LocTypeWorkshopSettlement))
            ...
            LTMN:Debug.Log(prefix + "      ** Player are in the settlement **");; Debug
        Else
            properties.IsInSettlement.SetValueInt(0)
            ShowMessage(properties.MESSAGE_PLAYER_OUT_SETTLEMENT);; Debug
            LTMN:Debug.Log(prefix + "      ** Player has left the settlement **");; Debug
        EndIf
    EndIf

    LTMN:Debug.Log(prefix + "  Automatic workshop links: " + (properties.AutomaticallyLinkOrUnlinkToWorkshop.GetValueInt() == 1));; Debug
    If (properties.AutomaticallyLinkOrUnlinkToWorkshop.GetValueInt() == 1)
        LTMN:Debug.Log(prefix + "    Workshops exist in the old location: " + (properties.WorkshopParent.GetWorkshopFromLocation(akOldLoc) != None));; Debug
        If (properties.WorkshopParent.GetWorkshopFromLocation(akOldLoc))
            LTMN:Debug.Log(prefix + "      Linked to Lootman: " + akOldLoc.IsLinkedLocation(properties.LootmanLocation, properties.WorkshopCaravan));; Debug
            If (akOldLoc.IsLinkedLocation(properties.LootmanLocation, properties.WorkshopCaravan))
                LTMN:Debug.Log(prefix + "      ** Removed link with Lootman **");; Debug
        ...
        LTMN:Debug.Log(prefix + "    Workshops exist in the new location: " + (properties.WorkshopParent.GetWorkshopFromLocation(akNewLoc) != None));; Debug
        If (properties.WorkshopParent.GetWorkshopFromLocation(akNewLoc))
            LTMN:Debug.Log(prefix + "      Linked to Lootman: " + akNewLoc.IsLinkedLocation(properties.LootmanLocation, properties.WorkshopCaravan));; Debug
            If (!akNewLoc.IsLinkedLocation(properties.LootmanLocation, properties.WorkshopCaravan))
                LTMN:Debug.Log(prefix + "      ** Added link to Lootman **");; Debug
    ...
    LTMN:Debug.Log(prefix + "*** The process performed when the location is changed has been completed ***");; Debug
EndEvent
...
Event ObjectReference.OnItemAdded(ObjectReference akSender, Form akBaseItem, int aiItemCount, ObjectReference akItemReference, ObjectReference akSourceContainer)
    ...
    If (properties.ShipmentItemList.HasForm(akBaseItem))
        LTMN:Debug.Log(prefix + "*** Lootman is loot the shipments, move to the player's inventory ***");; Debug
...
bool Function TryInstall()
    ...
    If (properties.IsInstalled.GetValueInt() == 1)
        LTMN:Debug.Log(prefix + "*** Lootman is already installed, the installation process will not be executed ***");; Debug
        Return true
    EndIf

    If (properties.IsUninstalled.GetValueInt() == 1)
        LTMN:Debug.Log(prefix + "*** Lootman has been uninstalled, the installation process will not be executed ***");; Debug
        Return true
    EndIf

    LTMN:Debug.Log(prefix + "*** Try to install Lootman ***");; Debug

    LTMN:Debug.Log(prefix + "  Player has a Pipboy: " + (player.GetItemCount(Pipboy) > 0));; Debug
    LTMN:Debug.Log(prefix + "  Institute's radio is ready to receive: " + RadioInstitute.IsRunning());; Debug
    ...
    If (player.GetItemCount(Pipboy) > 0 || RadioInstitute.IsRunning())
        LTMN:Debug.Log(prefix + "*** Execute the Lootman installation ***");; Debug
        Install()
        Return true
    Else
        LTMN:Debug.Log(prefix + "*** The Lootman installation was not executed ***");; Debug
        Return false
    EndIf
EndFunction
...
Function Install()
    ...
    LTMN:Debug.Log(prefix + "*** Start Lootman installation ***");; Debug

    LTMN:Debug.Log(prefix + "  ** Register an event **");; Debug
    ...
    LTMN:Debug.Log(prefix + "  ** Start thread manager **");; Debug
    ...
    LTMN:Debug.Log(prefix + "  ** Start timer function **");; Debug
    StartTimer(1, TIMER_INITIALIZE)
    StartTimer(3, TIMER_UPDATE_STATE)
    StartTimer(5, TIMER_LOOTING)

    LTMN:Debug.Log(prefix + "  ** Add utility holotape to the player's inventory **");; Debug
    ...
    LTMN:Debug.Log(prefix + "*** Lootman installation completed ***");; Debug
EndFunction
...
Function Uninstall()
    ...
    If (properties.IsInstalled.GetValueInt() != 1)
        LTMN:Debug.Log(prefix + "*** Lootman is not installed, the uninstallation process will not be executed ***");; Debug
        Return
    EndIf

    If (properties.IsUninstalled.GetValueInt() == 1)
        LTMN:Debug.Log(prefix + "*** Lootman has already been uninstalled, the uninstall process will not be executed ***");; Debug
        Return
    EndIf

    LTMN:Debug.Log(prefix + "*** Start Lootman uninstallation ***");; Debug

    properties.IsUninstalled.SetValueInt(1)

    LTMN:Debug.Log(prefix + "  ** Stop timer function **");; Debug
    CancelTimer(TIMER_TRY_INSTALL)
    CancelTimer(TIMER_LOOTING)
    CancelTimer(TIMER_UPDATE_STATE)
    CancelTimer(TIMER_INITIALIZE)

    LTMN:Debug.Log(prefix + "  ** Shutdown thread manager **");; Debug
    ...
    LTMN:Debug.Log(prefix + "  ** Unregister an event **");; Debug
    ...
    LTMN:Debug.Log(prefix + "*** Lootman uninstallation completed ***");; Debug
...
Function Initialize()
    ...
    If (properties.IsInitializing.GetValueInt() == 1)
        LTMN:Debug.Log(prefix + "*** Lootman is already in the process of initialization, the initialization process will not be executed ***");; Debug
        Return
    EndIf

    If (properties.IsUninstalled.GetValueInt() == 1)
        LTMN:Debug.Log(prefix + "*** Lootman has been uninstalled, the initialization process will not be executed ***");; Debug
        Return
    EndIf

    LTMN:Debug.Log(prefix + "*** Start Lootman initialization ***");; Debug

    properties.IsInitializing.SetValueInt(1)

    LTMN:Debug.Log(prefix + "  ** Clear form list **");; Debug
    ...
    LTMN:Debug.Log(prefix + "  ** Setup form list **");; Debug
    ...
    LTMN:Debug.Log(prefix + "*** Lootman initialization completed ***");; Debug
EndFunction
...
Function Patch()
    ...
    LTMN:Debug.Log(prefix + "*** Start patching Lootman ***");; Debug
    LTMN:Debug.Log(prefix + "  Current version: " + modVersion);; Debug

    ; Patches for version 1.3.6
    If (modVersion < 1.0306)
        LTMN:Debug.Log(prefix + "  Patches for version 1.3.6");; Debug
        AddInventoryEventFilter(properties.ShipmentItemList)
        RegisterForRemoteEvent(properties.LootmanActor, "OnItemAdded")
    EndIf
    ...
    LTMN:Debug.Log(prefix + "  Update to version: " + modVersion);; Debug
    LTMN:Debug.Log(prefix + "*** Lootman patching completed ***");; Debug
EndFunction
...
Function UpdaetState()
    ...
    If (properties.IsInitializing.GetValueInt() == 1)
        LTMN:Debug.Log(prefix + "*** Lootman is in the process of initialization, the state update will not be executed ***");; Debug
        Return
    EndIf

    If (properties.IsUninstalled.GetValueInt() == 1)
        LTMN:Debug.Log(prefix + "*** Lootman has been uninstalled, the state update will not be executed ***");; Debug
        Return
    EndIf

    If (!IsWorldActive())
        LTMN:Debug.Log(prefix + "*** World is not in active ***");; Debug
        Return
    EndIf

    LTMN:Debug.Log(prefix + "*** Start updating the state ***");; Debug

    LTMN:Debug.Log(prefix + "  Lootman's (Actor) inventory weight: " + properties.LootmanActor.GetInventoryWeight());; Debug
    If (properties.LootmanActor.GetInventoryWeight() > 0)
        LTMN:Debug.Log(prefix + "    ** Move items from actor to workshop **");; Debug
        LTMN:Quest:Methods.MoveInventoryItems(properties.LootmanActor, properties.LootmanWorkshop, -1, 0)
        LTMN:Debug.Log(prefix + "      Inventory weight after processing: " + properties.LootmanActor.GetInventoryWeight());; Debug
    EndIf
    ...
    LTMN:Debug.Log(prefix + "  Check for overweight in Lootman inventory: " + (properties.IgnoreOverweight.GetValueInt() != 1));; Debug
    If (properties.IgnoreOverweight.GetValueInt() != 1)
        LTMN:Debug.Log(prefix + "    Currently in an overweight state: " + (properties.IsOverweight.GetValueInt() != 0));; Debug
        LTMN:Debug.Log(prefix + "    Lootman's (Container) inventory weight: " + properties.LootmanWorkshop.GetInventoryWeight());; Debug
        LTMN:Debug.Log(prefix + "    Weight carrying capacity: " + properties.CarryWeight.GetValueInt());; Debug
        ...
        If (!wasOverweight && overweight)
            ...
            LTMN:Debug.Log(prefix + "    ** Overweight has been resolved **");; Debug
        ...
        ElseIf (wasOverweight && !overweight)
            ...
            messageShowCount = 0
            LTMN:Debug.Log(prefix + "    ** Now in an overweight state **");; Debug
        EndIf
    ElseIf (properties.IsOverweight.GetValueInt() != 0)
        properties.IsOverweight.SetValueInt(0)
    EndIf

    LTMN:Debug.Log(prefix + "  Automatically link Lootman to workshops: " + (properties.AutomaticallyLinkOrUnlinkToWorkshop.GetValueInt() == 1));; Debug
    ...
    If (AutomaticallyLinkOrUnlinkToWorkshop != lastAutomaticallyLinkOrUnlinkToWorkshop)
        LTMN:Debug.Log(prefix + "    ** Adjust the link status between Lootman and the workshop because Lootman's configuration has been changed **");; Debug
        LTMN:Debug.Log(prefix + "      Workshop exists at the current location: " + (properties.WorkshopParent.GetWorkshopFromLocation(player.GetCurrentLocation()) != None));; Debug

        Location currentLocation = player.GetCurrentLocation()
        If (properties.WorkshopParent.GetWorkshopFromLocation(currentLocation))
            LTMN:Debug.Log(prefix + "      Link to current location: " + currentLocation.IsLinkedLocation(properties.LootmanLocation, properties.WorkshopCaravan));; Debug
            ...
            If (!linkToCurrentLocation && AutomaticallyLinkOrUnlinkToWorkshop == 1)
                LTMN:Debug.Log(prefix + "      ** Add the link to the current location **");; Debug
            ...
            ElseIf (linkToCurrentLocation && AutomaticallyLinkOrUnlinkToWorkshop != 0)
                LTMN:Debug.Log(prefix + "      ** Remove the link to the current location **");; Debug
                currentLocation.RemoveLinkedLocation(properties.LootmanLocation, properties.WorkshopCaravan)
                ShowMessage(properties.MESSAGE_UNLINKED_TO_WORKSHOP);; Debug
            Else;; Debug
                LTMN:Debug.Log(prefix + "      ** No need to adjust the link status **");; Debug
            EndIf
        Else;; Debug
            LTMN:Debug.Log(prefix + "      ** No need to adjust the link status **");; Debug
        EndIf
    ...
    LTMN:Debug.Log(prefix + "  Suppress automatic looting in settlement: " + (properties.LootingDisabledInSettlement.GetValueInt() == 1));; Debug
    ...
    If (currentLootingDisabledInSettlement != lastLootingDisabledInSettlement)
        Location currentLocation = player.GetCurrentLocation()
        LTMN:Debug.Log(prefix + "    ** Adjust the flag whether you are staying in the settlement because Lootman's configuration has been changed **");; Debug
        LTMN:Debug.Log(prefix + "      Current location is a settlement (LocTypeSettlement): " + currentLocation.HasKeyword(Game.GetCommonProperties().LocTypeSettlement));; Debug
        LTMN:Debug.Log(prefix + "      Current location is a settlement (LocTypeWorkshopSettlement): " + currentLocation.HasKeyword(Game.GetCommonProperties().LocTypeWorkshopSettlement));; Debug
        ...
        LTMN:Debug.Log(prefix + "      Player is in the settlement: " + properties.IsInSettlement.GetValueInt());; Debug
    ...
    LTMN:Debug.Log(prefix + "*** State update is complete ***");; Debug
EndFunction
...
Function _ClearFormList(FormList list) global
    string prefix = ("| System | " + LTMN:Debug.GetRandomProcessID() + " | ");; Debug
    LTMN:Debug.Log(prefix + "** Delete all items in the form list **");; Debug
    LTMN:Debug.Log(prefix + "  Form list: [ID: " + LTMN:Debug.GetHexID(list) + "]");; Debug

    int i = list.GetSize()
    While i
        i -= 1
        Form item = list.GetAt(i)
        LTMN:Debug.Log(prefix + "    Remove: [Name: " + LTMN:Debug.GetIdentify(item) + ", ID: " + LTMN:Debug.GetHexID(item) + "]");; Debug
        list.RemoveAddedForm(item)
    EndWhile

    LTMN:Debug.Log(prefix + "** Delete all items in the form list has been completed **");; Debug
EndFunction
...
Function _SetupFormList(FormList list, string identify) global
    ...
    While i
        ...
        Form item = items[i]
        list.AddForm(item)
        LTMN:Debug.Log(prefix + "  Add: [Name: " + LTMN:Debug.GetIdentify(item) + ", ID: " + LTMN:Debug.GetHexID(item) + "]");; Debug
    EndWhile

    LTMN:Debug.Log(prefix + "** Items has been added to the form list **");; Debug
EndFunction
