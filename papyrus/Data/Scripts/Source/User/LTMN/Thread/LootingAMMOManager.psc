...
Function Startup()
    ...
    LTMN:Debug.Log("| Loot @ AMMO | *** Start thread manager ***");; Debug
...
Function Shutdown()
    LTMN:Debug.OpenLog();; Debug
    LTMN:Debug.Log("| Loot @ AMMO | *** Shutdown thread manager ***");; Debug
...
Function TryLooting()
    int threadLimit = LTMN:Lootman.GetProperties().ThreadLimitAMMO.GetValueInt()
