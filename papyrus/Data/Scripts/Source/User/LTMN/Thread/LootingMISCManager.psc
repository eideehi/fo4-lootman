...
Function Startup()
    ...
    LTMN:Debug.Log("| Loot @ MISC | *** Start thread manager ***");; Debug
...
Function Shutdown()
    LTMN:Debug.OpenLog();; Debug
    LTMN:Debug.Log("| Loot @ MISC | *** Shutdown thread manager ***");; Debug
...
Function TryLooting()
    int threadLimit = Lootman.GetProperties().ThreadLimitMISC.GetValueInt()
