...
Function Startup()
    ...
    LTMN:Debug.Log("| Loot @ ACTI | *** Start thread manager ***");; Debug
...
Function Shutdown()
    LTMN:Debug.OpenLog();; Debug
    LTMN:Debug.Log("| Loot @ ACTI | *** Shutdown thread manager ***");; Debug
...
Function TryLooting()
    int threadLimit = LTMN:Lootman.GetProperties().ThreadLimitACTI.GetValueInt()
