...
Function Startup()
    ...
    LTMN:Debug.Log("| Loot @ ALCH | *** Start thread manager ***");; Debug
...
Function Shutdown()
    LTMN:Debug.OpenLog();; Debug
    LTMN:Debug.Log("| Loot @ ALCH | *** Shutdown thread manager ***");; Debug
...
Function TryLooting()
    int threadLimit = Lootman.GetProperties().ThreadLimitALCH.GetValueInt()
