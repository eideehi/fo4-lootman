...
Function Startup()
    ...
    LTMN:Debug.Log("| Loot @ WEAP | *** Start thread manager ***");; Debug
...
Function Shutdown()
    LTMN:Debug.OpenLog();; Debug
    LTMN:Debug.Log("| Loot @ WEAP | *** Shutdown thread manager ***");; Debug
...
Function TryLooting()
    int threadLimit = Lootman.GetProperties().ThreadLimitWEAP.GetValueInt()
