...
Function Startup()
    LTMN:Debug.OpenLog()
    LTMN:Debug.Log("| Loot @ ARMO | *** Start thread manager ***")
...
Function Shutdown()
    LTMN:Debug.OpenLog()
    LTMN:Debug.Log("| Loot @ ARMO | *** Shutdown thread manager ***")
...
Function TryLooting()
    int threadLimit = LTMN:Lootman.GetProperties().ThreadLimitARMO.GetValueInt()
