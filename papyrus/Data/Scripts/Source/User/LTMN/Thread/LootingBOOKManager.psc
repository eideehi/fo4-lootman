...
Function Startup()
    ...
    Lootman.Log("| Loot @ BOOK | *** Start thread manager ***");; Debug
...
Function Shutdown()
    Lootman.OpenLog();; Debug
    Lootman.Log("| Loot @ BOOK | *** Shutdown thread manager ***");; Debug
...
Function TryLooting()
    int threadLimit = Lootman.GetProperties().ThreadLimitBOOK.GetValueInt()
