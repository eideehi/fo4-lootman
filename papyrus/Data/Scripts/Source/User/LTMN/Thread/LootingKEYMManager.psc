...
Function Startup()
    ...
    Lootman.Log("| Loot @ KEYM | *** Start thread manager ***");; Debug
...
Function Shutdown()
    Lootman.OpenLog();; Debug
    Lootman.Log("| Loot @ KEYM | *** Shutdown thread manager ***");; Debug
...
Function TryLooting()
    int threadLimit = Lootman.GetProperties().ThreadLimitKEYM.GetValueInt()
