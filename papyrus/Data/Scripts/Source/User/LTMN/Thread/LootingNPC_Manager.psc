...
Function Startup()
    ...
    LTMN:Debug.Log("| Loot @ NPC_ | *** Start thread manager ***");; Debug
...
Function Shutdown()
    LTMN:Debug.OpenLog();; Debug
    LTMN:Debug.Log("| Loot @ NPC_ | *** Shutdown thread manager ***");; Debug
...
Function TryLooting()
    int threadLimit = LTMN:Lootman.GetProperties().ThreadLimitNPC_.GetValueInt()
